...
function scriptsStream(bundlerArr) {
  var dev = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
...
function bundleScripts(bundlerArr) {
  var dev = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  var shouldThrow = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
...
exports.default = function (config) {
  ...
  _gulp2.default.task('scripts:dev', bundleScripts.bind(null, bundlers, true));
  _gulp2.default.task('scripts:prod', bundleScripts.bind(null, bundlers, false));
};